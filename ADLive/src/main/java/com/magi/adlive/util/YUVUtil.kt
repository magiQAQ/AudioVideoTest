...
import com.magi.adlive.encode.video.FormatVideoEncoder
...
object YUVUtil {
    ...
    fun NV21toYUV420byColor(input: ByteArray, width: Int, height: Int, formatVideoEncoder: FormatVideoEncoder): ByteArray? {
